...
export async function seedHabilidadeBNCCTableOrm() {
  ...
  // 2º Ano 
    ...
    //Ensino médio
    { codigo: "EM13LP01", descricao: "Ler e compreender textos de diferentes gêneros, considerando os contextos de produção e os efeitos de sentido.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP02", descricao: "Produzir textos orais e escritos com coerência, coesão e adequação aos gêneros e situações comunicativas.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP03", descricao: "Analisar os efeitos de sentido produzidos por diferentes recursos linguísticos e estilísticos em textos diversos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP04", descricao: "Reconhecer e utilizar recursos argumentativos em textos opinativos e dissertativos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP05", descricao: "Refletir sobre os usos da linguagem e suas implicações sociais, culturais e ideológicas.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP06", descricao: "Compreender e aplicar conhecimentos gramaticais para melhorar a produção e a interpretação de textos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP07", descricao: "Analisar criticamente discursos presentes nas mídias e nas redes sociais.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP08", descricao: "Produzir textos multimodais, integrando linguagem verbal, visual e sonora.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP09", descricao: "Interpretar textos literários, considerando aspectos estéticos, históricos e culturais.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP10", descricao: "Valorizar a literatura como forma de expressão artística e de construção da identidade cultural.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },

    
    { codigo: "EM13LP11", descricao: "Identificar e analisar os elementos constitutivos dos gêneros textuais, considerando suas funções sociais e comunicativas.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP12", descricao: "Utilizar estratégias de leitura para compreender textos complexos, como inferência, antecipação e contextualização.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP13", descricao: "Reconhecer e analisar os diferentes registros da língua portuguesa e suas variações regionais, sociais e históricas.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP14", descricao: "Produzir textos argumentativos com base em fontes diversas, respeitando os princípios da ética e da responsabilidade social.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP15", descricao: "Analisar criticamente discursos publicitários, políticos e midiáticos, identificando seus efeitos de persuasão.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP16", descricao: "Compreender e utilizar recursos linguísticos para construir sentidos em textos multimodais.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP17", descricao: "Interpretar textos literários de diferentes épocas e estilos, relacionando-os com o contexto histórico e cultural.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP18", descricao: "Valorizar a literatura como forma de expressão artística e de construção da identidade individual e coletiva.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP19", descricao: "Utilizar a norma padrão da língua portuguesa em situações formais de comunicação, respeitando as variações linguísticas.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP20", descricao: "Planejar, revisar e editar textos, considerando os objetivos comunicativos e os interlocutores.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },

   
    { codigo: "EM13LP21", descricao: "Analisar os processos de construção de sentido em textos literários e não literários, considerando os contextos de produção e recepção.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP22", descricao: "Reconhecer e utilizar diferentes estratégias argumentativas em textos de natureza opinativa.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP23", descricao: "Produzir textos autorais, respeitando os gêneros, os interlocutores e os objetivos comunicativos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP24", descricao: "Analisar os efeitos de sentido produzidos por figuras de linguagem e recursos estilísticos em textos diversos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP25", descricao: "Compreender e aplicar conhecimentos linguísticos para aprimorar a leitura e a produção textual.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP26", descricao: "Interpretar textos jornalísticos, publicitários e digitais, identificando seus objetivos e estratégias discursivas.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP27", descricao: "Valorizar a leitura como prática social e como forma de acesso ao conhecimento, à cultura e à cidadania.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP28", descricao: "Reconhecer e respeitar a diversidade linguística do português falado no Brasil e em outros países lusófonos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP29", descricao: "Analisar criticamente os discursos presentes em diferentes mídias, considerando seus efeitos sociais e ideológicos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP30", descricao: "Produzir textos colaborativos em ambientes digitais, respeitando os princípios da ética e da cidadania digital.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },

    { codigo: "EM13LP31", descricao: "Analisar criticamente os usos da linguagem em diferentes esferas sociais, reconhecendo seus efeitos de sentido e implicações ideológicas.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP32", descricao: "Produzir textos que articulem diferentes linguagens (verbal, visual, sonora), considerando os gêneros e os contextos de produção.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP33", descricao: "Compreender e utilizar recursos linguísticos para construir sentidos em textos multimodais e digitais.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP34", descricao: "Interpretar textos literários e não literários, relacionando-os com questões sociais, culturais e históricas.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP35", descricao: "Analisar os elementos constitutivos dos textos literários, como enredo, personagens, tempo, espaço e narrador.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP36", descricao: "Valorizar a literatura como forma de expressão estética, reflexão crítica e construção da identidade cultural.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP37", descricao: "Reconhecer e respeitar a diversidade de manifestações literárias, considerando diferentes culturas, épocas e estilos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP38", descricao: "Produzir textos literários autorais, explorando diferentes gêneros, temas e recursos expressivos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP39", descricao: "Analisar os processos de construção da argumentação em textos acadêmicos e científicos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP40", descricao: "Utilizar estratégias discursivas para defender pontos de vista em situações de debate e produção textual.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },

   
    { codigo: "EM13LP41", descricao: "Analisar criticamente os discursos presentes em textos jornalísticos, publicitários e políticos, considerando seus efeitos de sentido.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP42", descricao: "Produzir textos argumentativos com base em pesquisa e reflexão crítica sobre temas relevantes.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP43", descricao: "Compreender e aplicar os princípios da coesão e da coerência na produção textual.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP44", descricao: "Interpretar textos literários e não literários, identificando os elementos que contribuem para a construção de sentidos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP45", descricao: "Valorizar a leitura como prática de formação pessoal, social e cultural.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP46", descricao: "Reconhecer e utilizar diferentes registros da língua portuguesa, adequando-os às situações comunicativas.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP47", descricao: "Analisar os efeitos de sentido produzidos por recursos linguísticos em textos multimodais.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP48", descricao: "Produzir textos colaborativos em ambientes digitais, respeitando os princípios da ética e da cidadania.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP49", descricao: "Interpretar textos de diferentes gêneros, reconhecendo seus objetivos comunicativos e estratégias discursivas.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP50", descricao: "Compreender e aplicar conhecimentos linguísticos para aprimorar a leitura, a escrita e a oralidade.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },

      
    { codigo: "EM13LP51", descricao: "Analisar criticamente os discursos presentes em textos acadêmicos e científicos, considerando seus objetivos e estratégias argumentativas.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP52", descricao: "Produzir textos acadêmicos e científicos com clareza, objetividade e rigor argumentativo.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP53", descricao: "Compreender e aplicar normas da ABNT e outras convenções na produção de textos acadêmicos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13LP54", descricao: "Utilizar estratégias de pesquisa, seleção e organização de informações para fundamentar produções textuais.", etapaEnsino: "Ensino Médio", componenteCurricular: "Língua Portuguesa", anoSerie: "Ensino Médio", versao: "2025" },

    
    { codigo: "EM13MAT101", descricao: "Utilizar conceitos e procedimentos matemáticos para investigar e resolver problemas em diferentes contextos, valorizando a matemática como linguagem para representar e interpretar fenômenos naturais, sociais e tecnológicos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT102", descricao: "Construir e aplicar modelos matemáticos para representar e resolver problemas, analisando a adequação e as limitações desses modelos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT103", descricao: "Interpretar e produzir representações gráficas, tabelas e expressões algébricas, relacionando-as a diferentes contextos e finalidades.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT104", descricao: "Analisar e interpretar dados estatísticos, utilizando medidas de tendência central e de dispersão, para tomar decisões fundamentadas.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT105", descricao: "Compreender e aplicar conceitos de probabilidade para avaliar riscos e tomar decisões em situações de incerteza.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT106", descricao: "Utilizar conhecimentos geométricos para interpretar e resolver problemas que envolvam formas, tamanhos, posições relativas e propriedades de figuras no plano e no espaço.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },

    
    { codigo: "EM13MAT201", descricao: "Investigar propriedades de funções polinomiais, exponenciais e logarítmicas, analisando seus gráficos e comportamentos em diferentes contextos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT202", descricao: "Resolver problemas que envolvam progressões aritméticas e geométricas, aplicando fórmulas e raciocínio lógico.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT203", descricao: "Compreender e aplicar conceitos de trigonometria no estudo de triângulos e na modelagem de fenômenos periódicos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    
   
    { codigo: "EM13MAT301", descricao: "Investigar propriedades das funções afim, quadrática, exponencial e logarítmica, analisando seus gráficos e comportamentos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT302", descricao: "Resolver problemas que envolvam funções, identificando suas aplicações em contextos diversos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT303", descricao: "Compreender os conceitos de limite e continuidade de funções, explorando situações que envolvam variações e tendências.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT304", descricao: "Investigar os conceitos de derivada e sua aplicação na análise de taxas de variação e otimização de problemas.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT305", descricao: "Explorar os conceitos de integral definida e indefinida, relacionando-os ao cálculo de áreas e à modelagem de fenômenos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT306", descricao: "Utilizar matrizes e determinantes para resolver sistemas lineares e representar transformações geométricas.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT307", descricao: "Compreender os fundamentos da geometria analítica, aplicando-os na resolução de problemas envolvendo pontos, retas e circunferências.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT308", descricao: "Investigar propriedades das figuras geométricas espaciais, utilizando conceitos de volume, área e projeção.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT309", descricao: "Resolver problemas que envolvam relações métricas no triângulo, incluindo teoremas de Pitágoras, seno, cosseno e tangente.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT310", descricao: "Compreender os conceitos de números complexos e suas representações algébrica e geométrica.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT311", descricao: "Utilizar os números complexos na resolução de equações polinomiais e na representação de fenômenos oscilatórios.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT312", descricao: "Explorar os conceitos de combinatória, aplicando-os na contagem de possibilidades e na resolução de problemas.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT313", descricao: "Compreender os fundamentos da probabilidade condicional e independência de eventos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT314", descricao: "Interpretar e construir gráficos estatísticos, utilizando medidas de tendência central e dispersão.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT315", descricao: "Utilizar conceitos de estatística inferencial para analisar amostras e estimar parâmetros populacionais.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT316", descricao: "Modelar situações reais com funções e equações, avaliando a validade e os limites das representações matemáticas.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },

    
    { codigo: "EM13MAT401", descricao: "Investigar os fundamentos da lógica matemática e sua aplicação na construção de argumentos válidos e na resolução de problemas.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT402", descricao: "Compreender e aplicar os princípios da contagem, incluindo arranjos, permutações e combinações, em situações-problema.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT403", descricao: "Utilizar conceitos de probabilidade para avaliar riscos e tomar decisões em contextos diversos, incluindo jogos, pesquisas e estatísticas.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT404", descricao: "Analisar e interpretar dados estatísticos, utilizando medidas de tendência central e de dispersão para compreender fenômenos sociais e naturais.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT405", descricao: "Construir e interpretar gráficos estatísticos, reconhecendo suas potencialidades e limitações na comunicação de informações.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT406", descricao: "Compreender os fundamentos da estatística inferencial e aplicar procedimentos de amostragem e estimativa de parâmetros populacionais.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT407", descricao: "Utilizar ferramentas tecnológicas para coletar, organizar, analisar e representar dados estatísticos em diferentes contextos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },

    
    { codigo: "EM13MAT501", descricao: "Investigar os fundamentos da lógica matemática, utilizando proposições, conectivos e tabelas-verdade para construir argumentos válidos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT502", descricao: "Resolver problemas que envolvam raciocínio lógico, utilizando deduções, inferências e princípios da lógica formal.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT503", descricao: "Compreender os fundamentos da teoria dos conjuntos e suas aplicações na organização e classificação de dados.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT504", descricao: "Utilizar diagramas e operações com conjuntos para resolver problemas e representar relações entre elementos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT505", descricao: "Explorar os conceitos de relações e funções, identificando domínio, imagem e tipos de correspondência entre conjuntos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT506", descricao: "Modelar situações reais por meio de funções, analisando seus gráficos e propriedades para interpretar fenômenos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT507", descricao: "Investigar os conceitos de crescimento e decrescimento em funções, relacionando-os a contextos econômicos, sociais e naturais.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT508", descricao: "Compreender os conceitos de função inversa e composição de funções, aplicando-os na resolução de problemas.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT509", descricao: "Utilizar funções para representar e analisar fenômenos periódicos, como oscilação e movimento circular.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT510", descricao: "Explorar os conceitos de função exponencial e logarítmica, reconhecendo suas aplicações em contextos científicos e financeiros.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13MAT511", descricao: "Resolver problemas que envolvam equações exponenciais e logarítmicas, utilizando propriedades e estratégias algébricas.", etapaEnsino: "Ensino Médio", componenteCurricular: "Matemática", anoSerie: "Ensino Médio", versao: "2025" },

    
    { codigo: "EM13CNT101", descricao: "Compreender e aplicar conceitos das ciências naturais para explicar fenômenos e processos em diferentes escalas, reconhecendo a importância da investigação científica.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências da Natureza", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CNT102", descricao: "Investigar e avaliar impactos ambientais e propor soluções sustentáveis com base em conhecimentos científicos e tecnológicos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências da Natureza", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CNT103", descricao: "Utilizar conhecimentos das ciências naturais para compreender o funcionamento do corpo humano e promover a saúde individual e coletiva.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências da Natureza", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CNT104", descricao: "Analisar e interpretar dados e evidências científicas para tomar decisões fundamentadas em diferentes contextos sociais e ambientais.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências da Natureza", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CNT105", descricao: "Compreender os princípios da física, química e biologia envolvidos em tecnologias e processos produtivos, avaliando seus impactos sociais e ambientais.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências da Natureza", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CNT106", descricao: "Investigar transformações químicas e físicas da matéria, relacionando-as a fenômenos naturais e aplicações tecnológicas.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências da Natureza", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CNT107", descricao: "Analisar os ciclos biogeoquímicos e suas relações com os seres vivos e os ecossistemas, reconhecendo a importância da preservação ambiental.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências da Natureza", anoSerie: "Ensino Médio", versao: "2025" },

    
    { codigo: "EM13CNT201", descricao: "Investigar os processos de transformação da matéria e da energia, relacionando-os aos ciclos naturais e às atividades humanas.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências da Natureza", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CNT202", descricao: "Compreender os princípios da termodinâmica e suas aplicações em sistemas físicos, químicos e biológicos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências da Natureza", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CNT203", descricao: "Analisar os processos de transferência de energia e suas implicações nos sistemas vivos e tecnológicos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências da Natureza", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CNT204", descricao: "Investigar os mecanismos de transmissão de características hereditárias e suas implicações na diversidade dos seres vivos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências da Natureza", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CNT205", descricao: "Compreender os processos evolutivos e suas evidências, relacionando-os à biodiversidade e à adaptação dos seres vivos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências da Natureza", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CNT206", descricao: "Analisar os impactos das tecnologias sobre os sistemas naturais e sociais, propondo alternativas sustentáveis.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências da Natureza", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CNT207", descricao: "Investigar os processos de interação entre os seres vivos e o ambiente, considerando os fluxos de matéria e energia nos ecossistemas.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências da Natureza", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CNT208", descricao: "Compreender os fundamentos da química orgânica e suas aplicações em produtos naturais e sintéticos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências da Natureza", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CNT209", descricao: "Analisar os efeitos das radiações eletromagnéticas sobre os sistemas vivos e tecnológicos, considerando seus riscos e benefícios.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências da Natureza", anoSerie: "Ensino Médio", versao: "2025" },

    
    { codigo: "EM13CNT301", descricao: "Compreender os princípios da eletrodinâmica e suas aplicações em circuitos elétricos e sistemas tecnológicos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências da Natureza", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CNT302", descricao: "Investigar os fenômenos ondulatórios, incluindo som, luz e ondas eletromagnéticas, relacionando-os às suas aplicações no cotidiano.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências da Natureza", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CNT303", descricao: "Analisar os fundamentos da óptica geométrica e física, aplicando-os na interpretação de fenômenos naturais e tecnológicos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências da Natureza", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CNT304", descricao: "Compreender os princípios da mecânica clássica, incluindo leis do movimento e conservação de energia, aplicando-os na resolução de problemas.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências da Natureza", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CNT305", descricao: "Investigar os processos químicos de oxidação, redução e reações ácido-base, relacionando-os a fenômenos naturais e aplicações industriais.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências da Natureza", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CNT306", descricao: "Analisar os fundamentos da química orgânica e inorgânica, compreendendo suas propriedades, estruturas e reações.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências da Natureza", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CNT307", descricao: "Compreender os processos celulares e moleculares que sustentam a vida, incluindo metabolismo, síntese proteica e divisão celular.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências da Natureza", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CNT308", descricao: "Investigar os sistemas fisiológicos dos seres vivos e suas interações com o ambiente, promovendo a saúde e o bem-estar.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências da Natureza", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CNT309", descricao: "Analisar os impactos das ações humanas sobre os ecossistemas, propondo estratégias de conservação e uso sustentável dos recursos naturais.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências da Natureza", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CNT310", descricao: "Compreender os fundamentos da genética e da biotecnologia, avaliando suas aplicações e implicações éticas e sociais.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências da Natureza", anoSerie: "Ensino Médio", versao: "2025" },

    
    { codigo: "EM13CHS101", descricao: "Analisar processos históricos, geográficos, políticos, econômicos, sociais e culturais para compreender a formação da sociedade brasileira e suas dinâmicas contemporâneas.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências Humanas e Sociais Aplicadas", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CHS102", descricao: "Investigar diferentes formas de organização social e política ao longo da história, reconhecendo os conflitos, as permanências e as transformações.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências Humanas e Sociais Aplicadas", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CHS103", descricao: "Compreender os fundamentos da cidadania e dos direitos humanos, analisando sua aplicação nas relações sociais e nas políticas públicas.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências Humanas e Sociais Aplicadas", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CHS104", descricao: "Analisar criticamente os meios de comunicação e as redes sociais como espaços de produção e circulação de discursos e práticas sociais.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências Humanas e Sociais Aplicadas", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CHS105", descricao: "Investigar os impactos das ações humanas sobre o espaço geográfico, considerando aspectos ambientais, sociais e econômicos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências Humanas e Sociais Aplicadas", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CHS106", descricao: "Compreender os processos de globalização e suas implicações nas relações econômicas, culturais e políticas entre os povos e nações.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências Humanas e Sociais Aplicadas", anoSerie: "Ensino Médio", versao: "2025" },

    
    { codigo: "EM13CHS201", descricao: "Investigar os processos de formação das identidades individuais e coletivas, considerando aspectos históricos, culturais, sociais e políticos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências Humanas e Sociais Aplicadas", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CHS202", descricao: "Analisar os movimentos sociais e suas contribuições para a construção da cidadania e da democracia.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências Humanas e Sociais Aplicadas", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CHS203", descricao: "Compreender os processos de urbanização e suas implicações sociais, econômicas e ambientais nas diferentes regiões do Brasil e do mundo.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências Humanas e Sociais Aplicadas", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CHS204", descricao: "Investigar os impactos das políticas econômicas e sociais sobre as populações, considerando indicadores e dados estatísticos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências Humanas e Sociais Aplicadas", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CHS205", descricao: "Analisar os processos migratórios e suas consequências para as sociedades de origem e de destino, considerando aspectos históricos e contemporâneos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências Humanas e Sociais Aplicadas", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CHS206", descricao: "Compreender os fundamentos das instituições políticas e jurídicas, analisando seu papel na organização da vida social e na garantia dos direitos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências Humanas e Sociais Aplicadas", anoSerie: "Ensino Médio", versao: "2025" },

   
    { codigo: "EM13CHS301", descricao: "Analisar os fundamentos das teorias sociais e filosóficas que explicam as relações humanas e a organização da sociedade.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências Humanas e Sociais Aplicadas", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CHS302", descricao: "Investigar os processos de produção, circulação e consumo de bens e serviços, considerando os sistemas econômicos e suas implicações sociais.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências Humanas e Sociais Aplicadas", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CHS303", descricao: "Compreender os fundamentos da ética e da moral nas diferentes culturas e contextos históricos, analisando seus impactos nas práticas sociais.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências Humanas e Sociais Aplicadas", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CHS304", descricao: "Analisar os processos de construção das identidades culturais, considerando os elementos simbólicos, históricos e territoriais.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências Humanas e Sociais Aplicadas", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CHS305", descricao: "Investigar os conflitos sociais e suas formas de resolução, considerando os mecanismos institucionais e as práticas de mediação.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências Humanas e Sociais Aplicadas", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CHS306", descricao: "Compreender os processos de construção da memória coletiva e sua importância na preservação da identidade e da história dos povos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências Humanas e Sociais Aplicadas", anoSerie: "Ensino Médio", versao: "2025" },

 
    { codigo: "EM13CHS401", descricao: "Analisar os fundamentos das instituições democráticas e os mecanismos de participação política, reconhecendo seu papel na construção da cidadania.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências Humanas e Sociais Aplicadas", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CHS402", descricao: "Investigar os processos de construção das desigualdades sociais e suas implicações nas relações econômicas, políticas e culturais.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências Humanas e Sociais Aplicadas", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CHS403", descricao: "Compreender os fundamentos das relações internacionais e os desafios contemporâneos da geopolítica global.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências Humanas e Sociais Aplicadas", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CHS404", descricao: "Analisar os impactos das tecnologias da informação e comunicação nas práticas sociais, culturais e econômicas.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências Humanas e Sociais Aplicadas", anoSerie: "Ensino Médio", versao: "2025" },

    
    { codigo: "EM13CHS601", descricao: "Investigar os fundamentos das práticas culturais, religiosas e filosóficas, reconhecendo sua diversidade e importância na construção das identidades sociais.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências Humanas e Sociais Aplicadas", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CHS602", descricao: "Analisar os processos de colonização e descolonização, considerando seus impactos históricos, sociais e culturais nas sociedades contemporâneas.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências Humanas e Sociais Aplicadas", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CHS603", descricao: "Compreender os fundamentos das teorias políticas e econômicas modernas, relacionando-as aos contextos históricos e às práticas sociais atuais.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências Humanas e Sociais Aplicadas", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CHS604", descricao: "Investigar os processos de construção das fronteiras territoriais e suas implicações geopolíticas, econômicas e culturais.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências Humanas e Sociais Aplicadas", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CHS605", descricao: "Analisar os desafios contemporâneos relacionados aos direitos humanos, à justiça social e à equidade, propondo ações transformadoras.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências Humanas e Sociais Aplicadas", anoSerie: "Ensino Médio", versao: "2025" },
    { codigo: "EM13CHS606", descricao: "Compreender os processos de construção da memória histórica e sua importância na valorização da diversidade e na superação de preconceitos.", etapaEnsino: "Ensino Médio", componenteCurricular: "Ciências Humanas e Sociais Aplicadas", anoSerie: "Ensino Médio", versao: "2025" }
