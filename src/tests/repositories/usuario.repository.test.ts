...
beforeEach(async () => {
  ...
  await queryRunner.query('DROP TABLE IF EXISTS ocupacao');
...
describe('UsuarioRepository', () => {
  ...
  it('deve verificar se NODE_ENV afeta a criação de datas', async () => {
    ...
    const usuarioTest = new Usuario('Test User', ocupacaoTest?.id);
    ...
    const usuarioProd = new Usuario('Prod User', ocupacaoProd?.id);
